...
List of small projects to show my work with pointers and structures

First, I pushed a fix to my project "ESP32-S3_Arduino_UART" where I added pointers to the parameters of the writeAccelGyroLog() function and slightly rewrote its logic:
https://github.com/Dyusha37/ESP32-S3_Arduino_UART
